...
const contries = ['Scotland', 'England', 'Ireland', 'Wales', 'United Kingdom', 'Canada'];
...
const fortune = `In ${Math.floor(Math.random() * 10)} years, ${firstName} will be a(n) ${randJob}, in ${randContry}`;
